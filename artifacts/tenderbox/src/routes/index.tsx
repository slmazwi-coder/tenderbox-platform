...
const STATS: { label: string; value: string; hint: string; icon: LucideIcon; accent: string; to: string }[] = [
  { label: "Active Tenders", value: "24", hint: "8 closing this week", icon: FileText, accent: "bg-primary/10 text-primary", to: "/tenders" },
  { label: "Submitted Bids", value: "12", hint: "3 under review", icon: Send, accent: "bg-accent/10 text-accent", to: "/bids" },
  { label: "Payments Due", value: "R 184,500", hint: "2 invoices overdue", icon: CreditCard, accent: "bg-warning/10 text-warning", to: "/payments" },
...
const ACTIVITY = [
  { ref: "JHB-2026-014", entity: "City of Johannesburg", date: "29 May 2026", status: "approved", to: "/bids" },
  { ref: "ETH-2026-082", entity: "eThekwini Municipality", date: "02 Jun 2026", status: "pending", to: "/bids" },
  { ref: "CPT-2026-031", entity: "City of Cape Town", date: "11 Jun 2026", status: "pending", to: "/tenders" },
  { ref: "TSH-2026-007", entity: "City of Tshwane", date: "18 Jun 2026", status: "rejected", to: "/bids" },
];
    ...
    <div className="space-y-6">
      ...
      <section className="rounded-lg border border-border bg-card p-6 shadow-sm">
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
          <Link to="/tenders" className="inline-flex items-center justify-between gap-2 rounded-md bg-primary px-4 py-3 text-sm font-medium text-primary-foreground hover:bg-primary/90 transition-colors">
            <span>View Open Tenders</span>
            <ArrowRight className="h-4 w-4" />
          </Link>
          <Link to="/profile" className="inline-flex items-center justify-between gap-2 rounded-md border border-border bg-card px-4 py-3 text-sm font-medium text-foreground hover:bg-muted transition-colors">
            <span>Update Profile</span>
            <ArrowRight className="h-4 w-4" />
          </Link>
          <Link to="/payments" className="inline-flex items-center justify-between gap-2 rounded-md border border-border bg-card px-4 py-3 text-sm font-medium text-foreground hover:bg-muted transition-colors">
      ...
      <section className="rounded-lg border border-border bg-card shadow-sm">
        <div className="border-b border-border px-6 py-4 flex items-center justify-between">
          ...
          <Link to="/bids" className="text-xs text-primary hover:underline">View all bids →</Link>
        </div>
